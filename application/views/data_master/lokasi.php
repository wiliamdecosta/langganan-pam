...
<script>
    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."data_master.lokasi_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
                {label: 'ID', name: 'lokasi_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Nama Lokasi',name: 'lokasi_nama',width: 150, align: "left",editable: true,
                    editoptions: {
                        size: 30,
                        maxlength:50
                    },
                ...
                {label: 'Keterangan',name: 'lokasi_keterangan',width: 200, align: "left",editable: true,
                    edittype:'textarea',
                    editoptions: {
                        rows: 2,
                        cols:50
            ...
            editurl: '<?php echo WS_JQGRID."data_master.lokasi_controller/crud"; ?>',
            caption: "Lokasi"
