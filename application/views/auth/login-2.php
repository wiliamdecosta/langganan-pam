...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Sistem Informasi Gereja HKBP</title>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<?php echo base_url(); ?>">
                <img src="<?php echo base_url(); ?>assets/image/logo_hkbp.png" width="300px" height="" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" name="login_form" action="<?php echo $login_url;?>" method="post">
                <h4 class="form-title"><b>Sistem Informasi Gereja HKBP</b></h4>
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> Copyright &copy; 2018 Cristien Avrila Siregar. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
