	...
	styleUI : {
		...
		Bootstrap : {
			...
			base : {
				...
				pgButtonBox : "",
				icon_first : "fas fa-step-backward",
				icon_prev : "fas fa-backward",
				icon_next: "fas fa-forward",
				icon_end: "fas fa-step-forward",
				icon_asc : "glyphicon-triangle-top",
				icon_desc : "glyphicon-triangle-bottom",
				icon_caption_open : "fas fa-chevron-up",
				icon_caption_close : "fas fa-chevron-down"
			},
			modal : {
				modal : "modal-content",
				header : "modal-header",
			...
			inlinedit : {
				inputClass : 'form-control',
				icon_edit_nav : "fas fa-edit",
				icon_add_nav : "fas fa-plus",
				icon_save_nav : "fas fa-download",
				icon_cancel_nav : "far fa-times-circle"
			},
			formedit : {
				inputClass : "form-control",
				icon_prev : "fas fa-chevron-left",
				icon_next : "fas fa-chevron-right",
				icon_save : "fas fa-check",
				icon_close : "fas fa-times",
				icon_del : "far fa-trash-alt",
				icon_cancel : "fas fa-times"
			},
			navigator : {
				icon_edit_nav : "fas fa-edit",
				icon_add_nav : "fas fa-plus",
				icon_del_nav : "far fa-trash-alt",
				icon_search_nav : "fas fa-search",
				icon_refresh_nav : "fas fa-redo",
				icon_view_nav : "fas fa-info",
			...
			filter : {
				...
				icon_reset : 'fas fa-redo',
				icon_query :'fas fa-comment-alt'
			},
			subgrid : {
				icon_plus : 'glyphicon-triangle-right',
				icon_minus : 'glyphicon-triangle-bottom',
			...
			fmatter : {
				...
				icon_save : "fas fa-download",
				icon_cancel : "far fa-times-circle",
				icon_del : "far fa-trash-alt"
			},
			colmenu : {
				menu_widget : '',
